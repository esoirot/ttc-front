...
import { ClockifyPage } from "./ClockifyPage";

const meta: Meta<typeof ClockifyPage> = {
  component: ClockifyPage,
  title: "Pages/ClockifyPage",
  decorators: [
    (Story) => (
...
export default meta;
type Story = StoryObj<typeof ClockifyPage>;
