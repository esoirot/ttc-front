...
import { AdminTimeEntriesPage } from "./AdminTimeEntriesPage";

const meta: Meta<typeof AdminTimeEntriesPage> = {
  component: AdminTimeEntriesPage,
  title: "Pages/AdminTimeEntriesPage",
  decorators: [
    (Story) => (
      <QueryClientProvider client={new QueryClient()}>
        <MemoryRouter initialEntries={["/admin/time"]}>
          <Story />
        </MemoryRouter>
      </QueryClientProvider>
    ),
...
export default meta;
type Story = StoryObj<typeof AdminTimeEntriesPage>;
